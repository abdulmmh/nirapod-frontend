...
export type TaxType = 'VAT' | 'AIT' | 'Import Duty' | 'Income Tax'
                    | 'Excise Duty' | 'Supplementary Duty' | 'Other';
export type ApplicableTo = 'All' | 'Individual' | 'Company'
                         | 'Import' | 'Export' | 'Service' | 'Goods';
...
export interface TaxStructure {
  ...
  taxType:        TaxType;
  rateType:       RateType;
  rate:           number;       // used only when rateType = 'FLAT'
  slabs:          TaxSlab[];    // populated when rateType = 'SLAB'
