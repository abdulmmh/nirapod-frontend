...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'itr', component: PortalItrComponent },
      {
        ...
        component: PortalApplicationStatusComponent,
      },
      ...
      },
      {
        path: 'ait',
        loadChildren: () =>
          import('../../../features/ait/ait/ait.module').then(
            (m) => m.AitModule,
          ),
      },
      
      { path: 'appeals', component: PortalAppealListComponent },
      { path: 'appeals/new', component: PortalAppealCreateComponent },
      { path: 'appeals/:id', component: PortalAppealDetailComponent },
