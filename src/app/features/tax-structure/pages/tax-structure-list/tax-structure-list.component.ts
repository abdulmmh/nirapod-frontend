...
export class TaxStructureListComponent implements OnInit {
  ...
  private fallback: TaxStructure[] = [
    ...
    },
    {
      id: 3,
      taxCode: 'TAX-003',
      taxName: 'AIT on Salary',
      taxType: 'AIT',
      rate: 10,
      applicableTo: 'Individual',
      effectiveDate: '2024-07-01',
      expiryDate: '',
      description: 'Advance Income Tax deducted at source from salary',
      status: 'Active',
      createdBy: 'Tax Commissioner',
    ...
    },
    {
      id: 4,
      taxCode: 'TAX-004',
      taxName: 'AIT on Import',
      taxType: 'AIT',
      rate: 5,
      applicableTo: 'Import',
      effectiveDate: '2024-01-01',
      expiryDate: '',
      description: 'AIT on import of goods',
      status: 'Active',
      createdBy: 'Tax Commissioner',
      createdAt: '2024-01-01',
    },
    {
      id: 5,
      taxCode: 'TAX-005',
      taxName: 'General Import Duty',
      taxType: 'Import Duty',
      rate: 25,
      applicableTo: 'Import',
      effectiveDate: '2024-01-01',
      expiryDate: '',
      description: 'Standard import duty on general goods',
      status: 'Active',
      createdBy: 'Tax Commissioner',
      createdAt: '2024-01-01',
    },
    {
      id: 6,
      taxCode: 'TAX-006',
      taxName: 'Electronics Import Duty',
      taxType: 'Import Duty',
      rate: 10,
      applicableTo: 'Import',
      effectiveDate: '2024-01-01',
      expiryDate: '2024-12-31',
      description: 'Reduced duty on electronics',
      status: 'Expired',
      createdBy: 'Tax Commissioner',
      createdAt: '2024-01-01',
    },
    {
      id: 7,
      taxCode: 'TAX-007',
      taxName: 'Supplementary Duty',
      taxType: 'Supplementary Duty',
      rate: 20,
      applicableTo: 'Goods',
      effectiveDate: '2024-01-01',
      expiryDate: '',
      description: 'SD on luxury goods',
      status: 'Active',
      createdBy: 'Tax Commissioner',
      createdAt: '2024-01-01',
    },
    {
      id: 8,
      taxCode: 'TAX-008',
      taxName: 'AIT on Contract',
      taxType: 'AIT',
      rate: 7,
      applicableTo: 'Company',
      effectiveDate: '2024-01-01',
      expiryDate: '',
      description: 'AIT on contract payments to companies',
      status: 'Active',
      createdBy: 'Tax Commissioner',
      createdAt: '2024-01-01',
    },
  ...
  view(id: number): void {
    this.router.navigate(['/tax-structure/view', id]);
  }
  edit(id: number): void {
    this.router.navigate(['/tax-structure/edit', id]);
  }

  navigateCreate(): void {
    this.router.navigate(['/tax-structure/create']);
  }
}
