...
export class ReportsDashboardComponent {
  ...
  reportCards = [
    ...
    },
    {
      ...
      color: 'navy',
      desc: 'Audit assignments, findings and resolutions',
      count: '142',
    },
    {
      title: 'Taxpayer Registration Report',
      icon: 'bi bi-people-fill',
      color: 'green',
      desc: 'New taxpayer registrations and TIN issuance trends',
      count: '+1,240',
    },
  ];
  ...
  summaryStats = [
    {
      label: 'Total Revenue (FY 2024-25)',
      value: '৳45.9 Cr',
      change: '+8.3%',
