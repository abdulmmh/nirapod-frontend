...
export class UserListComponent implements OnInit {
  ...
  private fallback: AppUser[] = [
    ...
    },
    {
      ...
      username: 'auditor_01',
      email: 'khossain@nbr.gov.bd',
      role: 'AUDITOR',
      department: 'Audit Division',
      lastLogin: '2026-03-30 10:45',
      status: 'Active',
    ...
    },
    {
      ...
      username: 'data_01',
      email: 'fbegum@nbr.gov.bd',
      role: 'DATA_ENTRY_OPERATOR',
      department: 'Data Management',
      lastLogin: '2026-03-28 16:30',
      status: 'Active',
    ...
    },
    {
      ...
      username: 'taxpayer_01',
      email: 'akarim@example.com',
      role: 'TAXPAYER',
      department: 'External',
      lastLogin: '2026-03-25 11:00',
      status: 'Active',
    ...
    },
    {
      ...
      username: 'tax_off_02',
      email: 'ruddin@nbr.gov.bd',
      role: 'TAX_OFFICER',
      department: 'Income Tax Division',
      lastLogin: '2026-02-15 09:00',
      status: 'Inactive',
      createdAt: '2024-03-15',
    },
    {
      id: 8,
      fullName: 'Samira Islam',
      username: 'auditor_02',
      email: 'sislam@nbr.gov.bd',
      role: 'AUDITOR',
      department: 'Audit Division',
