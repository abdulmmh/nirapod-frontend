...
export class ImportDutyListComponent implements OnInit {
  ...
  private fallback: ImportDuty[] = [
    ...
    {
      id: 3,
      dutyRef: 'IMP-2024-00003',
      tinNumber: 'TIN-1004',
      taxpayerName: 'Faruk Hossain',
      businessName: 'Chittagong Exports',
      productName: 'Passenger Car',
      hsCode: '8703.23.10',
      goodsDescription: '3x Toyota Corolla 1800cc',
      originCountry: 'Japan',
      cifValue: 9000000,
      dutyRate: 25,
      dutyAmount: 2250000,
      vatOnImport: 1706250,
      totalPayable: 3956250,
      paidAmount: 0,
      portOfEntry: 'Chittagong Port',
      billOfLading: 'BL-2024-66743',
    ...
    {
      id: 4,
      dutyRef: 'IMP-2024-00004',
      tinNumber: 'TIN-1006',
      taxpayerName: 'Imran Ahmed',
      businessName: 'BD Tech Solutions',
      productName: 'Mobile Phone',
      hsCode: '8517.12.00',
      goodsDescription: '500x Smartphones',
      originCountry: 'China',
      cifValue: 3000000,
      dutyRate: 25,
      dutyAmount: 750000,
      vatOnImport: 562500,
      totalPayable: 1312500,
      paidAmount: 1312500,
      portOfEntry: 'Dhaka Air Freight',
      billOfLading: 'AWB-2024-77854',
      importDate: '2024-04-10',
    ...
    {
      id: 5,
      dutyRef: 'IMP-2024-00005',
      tinNumber: 'TIN-1002',
      taxpayerName: 'Karim Uddin',
      businessName: 'Karim Traders',
      productName: 'Woven Fabric',
      hsCode: '5208.11.10',
      goodsDescription: '10,000m Cotton Fabric',
      originCountry: 'Bangladesh (Re-import)',
      cifValue: 800000,
      dutyRate: 5,
      dutyAmount: 40000,
      vatOnImport: 126000,
      totalPayable: 166000,
      paidAmount: 0,
      portOfEntry: 'Dhaka ICD',
      billOfLading: 'BL-2024-88965',
